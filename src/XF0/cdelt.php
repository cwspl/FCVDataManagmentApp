...
if(isset($_GET['id']) && $_GET['id'] != 0){
	$gcid = $_GET['id'];
	$qury = "SELECT * FROM `vklist` WHERE `id` = '".$gcid."'";
...
<div align="center" id="cntr<?php echo $cd['id'];?>">
	...
	<button type="button" onclick="odiv_a('XF0/rcdelt','?id=<?php echo $cd['id']; ?>&delete=yes','cntr<?php echo $cd['id'];?>');" class="btn btn-social btn-danger">
