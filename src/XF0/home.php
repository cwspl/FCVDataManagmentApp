...
<div align="center">
	<div class="col-md-6">
		<button type="button" onclick="odiv('XF0/tab/tab_a', 'cnt');" class="btn btn-lg btn-block btn-social btn-info">
			All Connection <span class="badge"><?php  echo mysqli_num_rows(mysqli_query($conn, "SELECT * FROM vklist"));?></span>
		</button>
		<br/>
	</div>
	<div class="col-md-6">
	...
	<div class="col-md-6">
		...
		<div class="input-group">
			<input type="text" onkeyup="src_c('sqn','screlt','XF0/srn')" id="sqn" class="form-control" style="text-align:center;" placeholder="Name">
			<span class="input-group-btn"><button onclick="src_c('sqn','screlt','XF0/srn')" class="btn btn-primary"><i class="glyphicon glyphicon-search"></i></button></span>
		</div>
