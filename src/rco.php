...
?>
<div align="center">
	<h4 style="clear: both; border-bottom: 1.5px solid #f4f4f4;color:gray;" align="center"> Restart Connection </h4>
	<div>
		<input type="hidden" id="fid<?php echo $cd['id'];?>" value="<?php echo $cd['id'];?>" />
		<i style="color:red;" id="errs<?php echo $cd['id'];?>"></i><br/>
		<label>With Monthly Fund Amount</label><br/>
		<div class="input-group">
			<input type="tel" id="famt<?php echo $cd['id'];?>" class="form-control" style="text-align:center;" placeholder="Fund Amount" value="170">
		</div><br/>
		...
		<button type="button" onclick="cmf('fid<?php echo $cd['id'];?>','famt<?php echo $cd['id'];?>','cmm<?php echo $cd['id'];?>','cmy<?php echo $cd['id'];?>','rcmf2','tchg<?php echo $cd['id'];?>','errs<?php echo $cd['id'];?>');" class="btn btn-block btn-social btn-success">
...
<div align="center">
	<div class="col-md-6">
		<h4 style="clear: both; border-bottom: 1.5px solid #f4f4f4;color:gray;" align="center"> Restart Connection </h4><br/>
		<div id="abot">
	...
	<div class="col-md-6">
		...
		<label>With Monthly Fund Amount</label><br/>
		<div class="input-group">
			<input type="tel" id="famt" class="form-control" style="text-align:center;" placeholder="Fund Amount" value="170">
		</div><br/>
		<label>Start From</label><br/>
		<div class="input-group">
			<span class="input-group-addon">Month</span>
		...
		<button type="button" onclick="cmf('fid','famt','cmm','cmy','rcmf','cn2','errs');" class="btn btn-block btn-social btn-success">
			<i class="glyphicon glyphicon-repeat"></i> Restart Connection
		</button><br/>
	</div>
	<br/>
