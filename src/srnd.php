...
if($n > 0){
	...
	?>
	<button class="btn btn-default btn-sm btn-block btn-flat" onclick="odiv_a('dltc','?cid=<?php echo $ad['id'];?>','cn2')"><b><?php echo $ad['name'];?></b><br/><i><?php echo $ad2['name'];?></i></button>
<?php } } else {
$q = $_GET['q'];
if($_SESSION['fcv'] == 0){
