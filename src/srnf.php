...
if($n > 0){
	...
	?>
	<button class="btn btn-default btn-sm btn-block btn-flat" onclick="adfic('fid','<?php echo $ad['id'];?>','<?php echo $ad['name'];?> From <?php echo $ad2['name'];?>')"><b><?php echo $ad['name'];?></b><br/><i><?php echo $ad2['name'];?></i></button>
<?php } } else {
$q = $_GET['q'];
if($_SESSION['fcv'] == 0){
